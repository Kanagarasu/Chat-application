    ...
    <div className='p-6 border-slate-700/50 '>
      <div className='flex items-center justify-between'>
        <div className='flex items-center grap-3'>
          ...
          {/* if the classname is avatar online then it shows top right of the profile green dote */}
          {/* if the classname is avatar offline then it not shows top right of the profile green dote */}
          ...
          <div className='avatar online'>
            ...
            >
              ...
              {/* below div for if the user hover the image then show the text for change */}
            ...
            <input type="file"
              ...
              className='hidden'
            />
            {/* initialy the file input is hidden. if the user is click the image or icon the then get the input for the profile image */}
          ...
          {/* logout button and sound button */}
